...
if (isset($_GET["succes"])==1) {?>
  ...
  <div class="alert-success">
    <p>
      Votre réservation à bien était prise en compte
    </p>
  </div>
  </div> <?php
}?>
...
/*$z=0;
while ($ligne2=$reqe2->fetch(PDO::FETCH_ASSOC))
				{
					$tab[$z]=$ligne2["description"];
					$z++;
				}
...
<div class="nav justify-content-end" >
                   <form class="form-inline my-3 my-lg-1" method="POST" action="reservation.php">
					...
					<tr>
						...
						{ ?>
							<td>
								...
								if ($salle1=='') 
								{?>
								<?php echo"<a href='res_salle.php?date=".$date."&heured=".$plage."&heuref=".$plage2."&salle=".$id_salle."'>Disponible</a>"?><?php
									}
									else
									{
